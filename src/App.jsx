  ...
  return (
    <>
     ...
     h-20 w-48 mx-auto md:mx-0 md:absolute top-10 left-10'
        ...
        {/* <!-- Menu  --> */}
        <div
          className='flex items-cener justify-center space-x-4
      md:space-x-10 md:absolute top-12 right-10'
        >
          ...
          <button
            ...
            dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-700
            dark:foculs:ring-gray-700 rounded-lg text-sm p-2 5'
          >
            {/* <!-- Dark SVG Icon --> */}
            <svg
...
function App() {
  return (
    ...
    // </QueryClientProvider>
>>>>>>> ed9c925f1efe57895fa07c6e7ef2eaba0f0e64e2
  );
}
